...
describe('Guest API', function () {
    ...
    describe('#GET /fetchJobs', function () {
        ...
        it('should perform a search by text', fetchJobsTests.searchByText);
        it('should perform a search by salary', fetchJobsTests.searchBySalary);
        ...
        it('should perform a search by tex, salary and an intersection of two sets', fetchJobsTests.searchByAllOptions);
