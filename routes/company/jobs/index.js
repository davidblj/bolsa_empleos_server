...
const updateJob = require(process.cwd() + '/controllers/company/jobs/updateJob');
...
router.put('/:jobId', handler(updateJob, status.NO_CONTENT,
    (req, res, next) => [req.body, req.jobId])
);
